//
//  RockNameSettingViewController.swift
//  TunnelManagementApp
//
...
class RockNameSettingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func addButton(_ sender: Any) {
        ...
        // rockNameに追加する
        self.rockName.append(addRockNameTextField.text)
    ...
    override func viewDidLoad() {
        ...
        // rockNameの出力確認
        if let rockName = self.tunnelSpecData?.rockName {
